    ...
    <div className="flex h-screen bg-slate-50 font-sans text-slate-800 overflow-hidden">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shadow-sm z-20">
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1">
          ...
          <SidebarItem icon={Settings} label="Media & Fitur" active={activeTab === 'media'} onClick={() => setActiveTab('media')} />
          ...
          <SidebarItem icon={LayoutDashboard} label="Manajemen Device" active={activeTab === 'devices'} onClick={() => setActiveTab('devices')} />
        </nav>
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shadow-sm z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-slate-400 bg-slate-100 px-2 py-1 rounded">SaaS v2.0</span>
